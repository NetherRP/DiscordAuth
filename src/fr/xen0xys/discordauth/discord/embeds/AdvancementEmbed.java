...
public class AdvancementEmbed extends EmbedBuilder implements CustomEmbed{
    ...
    public AdvancementEmbed(Player player, String advancementName){
        ...
        this.setAuthor(String.format(String.format(DiscordAuth.getLanguage().successComplete, player.getName(), advancementName), player.getName()), null, PluginUtils.getPlayerSkinURL(player));
    }
    ...
    public AdvancementEmbed(Player player, String[] advancements_name){
        ...
        this.setAuthor(String.format(String.format(DiscordAuth.getLanguage().successComplete, player.getName(), finalAdvancementString), player.getName()), null, PluginUtils.getPlayerSkinURL(player));
    }
