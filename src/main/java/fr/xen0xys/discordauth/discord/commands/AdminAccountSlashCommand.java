...
public class AdminAccountSlashCommand {
    ...
    public AdminAccountSlashCommand(){
        // Create
        SubcommandData createCommandData = new SubcommandData("create", "Create user's account");
        createCommandData.addOption(OptionType.STRING, "discordid", "User's discord id", true);
        ...
        createCommandData.addOption(OptionType.STRING, "confirm", "User's account password", true);
        // Manage
        SubcommandData manageCommandData = new SubcommandData("manage", "Manage user's account");
        manageCommandData.addOption(OptionType.STRING, "discordid", "User's discord id", true);
        ...
        deleteCommandData.addOption(OptionType.STRING, "discordid", "User's discord id", true);
        // Create command data
